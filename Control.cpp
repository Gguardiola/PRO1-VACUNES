...
void Control::afegir_unitats(int n, string id, int q){
...
void Control::treure_unitats(int n, string id, int q){
...
//consultors
void Control::consultar_vac(string id) const{
    //PRE: string de la id de la vacuna
    //POST: comprueba si la vacuna esta definida o no.
    //Si existe, devuelve la cantidad total de vacunas con esa id que existe en todas las neveras. En caso de no existir devuelve muestra "error".
